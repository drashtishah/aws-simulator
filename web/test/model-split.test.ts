...
// constants, not inline literals. See Issue #107 and #270. Both play and
// post-session run on Opus: Sonnet leaked root cause under the persona
// prompt. Do not flip without an A/B on quality.
