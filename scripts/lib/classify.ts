 ...
 * graphify-out/ is generated by `graphify update`; not authored code. */
export const EXCLUDED_PREFIXES: string[] = [
  '.claude/plans/',
  'graphify-out/',
];

/** True if the path is explicitly excluded from scoring (generated/out-of-scope). */
export function isExcluded(rawPath: string): boolean {
...
module.exports = { classify, BUCKETS, defaultBucketWeights, isExcluded, EXCLUDED_PREFIXES };
...
module.exports.EXCLUDED_PREFIXES = EXCLUDED_PREFIXES;
